...
import lenimarPescadoEntero from "@assets/productos/lenymar-pescado-entero.jpg";
...
export const conservaData = [
  {
    ...
    description:
      "Duraznos Lenysol en lata de 820g procedente de Grecia. Tableta x 12 unds.",
    weight: 820,
  },
  {
    id: "ddelys_filete_de_caballa",
    brand: "CONSERVA DE PESCADO",
    name: "D'DELYS FILETE DE CABALLA",
    image: conservaFileteCaballa,
    description: "Filete de Caballa envasado en aceite vegetal.",
    weight: 170,
  },
  {
    id: "dely_fish_filete_de_caballa",
    brand: "CONSERVA DE PESCADO",
    name: "DELY FISH FILETE DE CABALLA",
  ...
  {
    id: "lenymar_filete_de_atun",
    brand: "CONSERVA DE PESCADO",
    name: "LENYMAR FILETE DE ATUN",
    image: lenimarFileteAtun,
    description: "Filete de Atún envasado en aceite vegetal.",
    weight: 170,
  },

  {
    id: "lenymar_filete_de_caballa",
    brand: "CONSERVA DE PESCADO",
    name: "LENYMAR FILETE DE CABALLA",
    image: lenimarCaballa,
    description: "Filete de Caballa envasado en aceite vegetal.",
    weight: 170,
  },
  {
    id: "lenymar_trozos_de_atun ",
    brand: "CONSERVA DE PESCADO",
    name: "LENYMAR TROZOS DE ATUN ",
    image: lenimarFileteAtunAzul,
    description: "Trozos de Atún envasado en aceite vegetal.",
    weight: 170,
  },
  {
  ...
  {
    id: "lenymar_tall_entero_de_pescado",
    brand: "CONSERVA DE PESCADO",
    name: "LENYMAR TALL ENTERO DE PESCADO",
  ...
  {
    id: "lenysol_grated_de_sardinas",
    brand: "CONSERVA DE PESCADO",
    name: "LENYSOL GRATED DE SARDINAS",
    image: lenysolGratedSardina,
    description: "Filete de caballa envasado en aceite vegetal.",
    weight: 170,
  },
